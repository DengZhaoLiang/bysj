...
public class AdminRecord extends UpdatableRecordImpl<AdminRecord> implements Record6<ULong, String, String, String, LocalDateTime, LocalDateTime>, IAdmin {

    private static final long serialVersionUID = 890978174;
    ...
    @Override
    public AdminRecord values(ULong value1, String value2, String value3, String value4, LocalDateTime value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AdminRecord(ULong id, String name, String account, String password, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(Admin.ADMIN);
